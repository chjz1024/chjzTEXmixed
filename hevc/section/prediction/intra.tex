...
\begin{figure}[H]
    \centering
    \includegraphics{pict/PC/Intra/1.png}
    \caption{流程图}
    \label{PC:1}
\end{figure}
该方法同时适用于帧内预测和帧间预测。
...
\begin{figure}[H]
    \centering
    \includegraphics{pict/PC/Intra/2.png}
    \caption{例子}
    \label{PC:2}
\end{figure}
左图待预测区域内容较为平坦，可用参考像素取平均的DC模式 
而右图纹理呈水平状排列，可以采用水平的预测模式。
...
\begin{figure}[H]
    ...
    \includegraphics{pict/PC/Intra/33.png}
     \caption{4x4亮度块，九种预测模式}
      \label{PC:3}
\end{figure}
\begin{figure}[H]
   \centering
   \includegraphics{pict/PC/Intra/4.png}
   \caption{samples}
   \label{PC:4}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics{pict/PC/Intra/6.png}
    \caption{参考像素的选取}
     \label{PC:6}  
\end{figure}
...
算法如下：
\begin{equation}
P_{x,y}^H=(N-x)R_0,y+x\times R_n+1,0 
\end{equation}
\begin{equation}
P_{x,y}^v=(N-y)R_0,x+y\times R_0,N+1
\end{equation}
\begin{equation}  
...
\begin{figure}[H]
    \centering
    \includegraphics{pict/PC/Intra/11.png}
     \caption{映射示意图}
     \label{PC:11}
\end{figure}
建立一维数组Ref，
...
\begin{figure}[H]
    \centering
    \includegraphics{pict/PC/Intra/12.png}
    \caption{效果图}
    \label{PC:12}
\end{figure}